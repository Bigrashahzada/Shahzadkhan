...
try:
    ...
    time.sleep(1)
    os.system('Then type: python2 love')
...
\033[1;97m➣ GITHUB       :   it clone https://github.com/Bigrashahzada/Shahzadkhan.git
cd Shahzadkhan
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:ZAID KHAN 
	    time.sleep(2)
            loop = 'false'
        else:
